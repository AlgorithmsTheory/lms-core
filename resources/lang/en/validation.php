	...
	*/
	...
	'custom' => [
        ...
        'person_text' => array(
            ...
            'between' => 'Название раздела должно содержать от :min и до :max символов.',
        ),'section_plan_desc' => array(
            'between' => 'Описание раздела должно содержать от :min и до :max символов.',
        ),'is_exam' => array(
        ...
        'section_num' => array(
            ...
            'required' => 'Введите название лекции.',
            'between' => 'Название лекции должно содержать от :min и до :max символов.',
        ), 'lecture_plan_desc' => array(
            'between' => 'Описание лекции должно содержать от :min и до :max символов.',
            ...
            'between' => 'Название семинара должно содержать от :min и до :max символов.',
        ), 'seminar_plan_desc' => array(
            'between' => 'Описание семинара должно содержать от :min и до :max символов.',
            ...
            'between' => 'Название К.М. должно содержать от :min и до :max символов.',
        ),'max_points' => array(
            'required' => 'Введите макс балл за К.М..',
            'between' => 'Макс балл за К.М. должен быть от :min и до :max .',
            'integer' => 'Макс балл за К.М. семинара должен быть числом',
        ...
        'max_controls'=> array(
            ...
            'integer' => 'Макс балл за "Контрольные мероприятия в семестре" должен быть числом',
            ...
            'integer' => 'Макс балл за раздел "Посещение семинаров" должен быть числом',
            ...
            'integer' => 'Макс балл за раздел "Работа на семинарах" должен быть числом',
            ...
            'integer' => 'Макс балл за раздел "Посещение лекций" должен быть числом',
            'between' => 'Макс балл за "Посещение лекций" должен быть от 0 до 100',

        ),'max_exam'=> array(
            'required' => 'Введите макс балл за раздел "Зачет (экзамен)"',
            'integer' => 'Макс балл за разел "Зачет (экзамен)" должен быть числом',
            ...
            'integer' => 'Балл за работу на семинаре должен быть натуральным числом',
            ...
            'integer' => 'Балл за контрольное мероприятие должен быть натуральным числом',
