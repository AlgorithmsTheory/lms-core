...
return [
	...
	*/
	...
	'custom' => [
        ...
        ), 'form.lecture_plan_name' => array(
            'required' => 'Введите название лекции.',
            'between' => 'Название лекции должно содержать от :min и до :max символов.',
        ), 'form.lecture_plan_desc' => array(
            'between' => 'Описание лекции должно содержать от :min и до :max символов.',
        ),'form.lecture_plan_num' => array(
            'required' => 'Введите порядковый номер лекции.',
            'integer' => 'Номер лекции должен быть числом',
            'min' => 'Номер лекции должен быть не меньше 1',
            'unique' => 'Номер лекции в данном разделе уже существует'
        ),'extra_header' => array(
            'required' => 'Введите заголовок доп. материала.',
            'max' => 'Заголовок должен содержать до 355 символов',
        ),'extra_file' => array(
