<!DOCTYPE html>
<!-- saved from url=(0040)http://s.codepen.io/akm2/fullpage/rHIsa? -->
...
<canvas id="c" width="1680" height="410" style="cursor: pointer;"></canvas>
{{--<script src="./stopExecutionOnTimeout-ddaa1eeb67d762ab8aad46508017908c.js"></script>--}}
    ...
    {{--<div class="dg main a" style="width: 245px;">--}}
        ...
        {{--<ul style="height: auto;" class="">--}}
            {{--<li class="cr number has-slider">--}}
                {{--<div>--}}
                    {{--<span class="property-name">Particle Num</span>--}}
                    {{--<div class="c">--}}
                        {{--<div>--}}
                            {{--<input type="text" value="500">--}}
                        {{--</div>--}}
                        {{--<div class="slider">--}}
                            {{--<div class="slider-fg" style="width: 16.6667%;">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
            ...
            {{--<li class="cr boolean">--}}
                {{--<div>--}}
                    {{--<span class="property-name">Interference Between Point</span>--}}
                    {{--<div class="c">--}}
