                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{URL::route('student_order_delete')}}" method="POST">
                            ...
                            <br>
                            <center><input type="submit" class="btn ink-reaction btn-primary" value="Удалить из списка">

                        </form>
                            <button class="btn ink-reaction btn-default-light" />{!! HTML::linkRoute('student_lib_account2', 'Архив заказов') !!}
                        </center>
                    </div><!--end .card -->
                </div><!--end .col -->
