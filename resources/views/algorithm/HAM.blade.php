										...
										<ul id="p_scents" class="list" data-sortable="true">
											<li id="p_scnt" class="tile">
												<div class="input-group">
													...
													<input type="text"  onchange="$('input').superScript(this);" id="text"  class="form-control" name="start" >
													</div>
														<span class="input-group-addon"><i class="md md-arrow-forward"></i></span>
													<div class="input-group-content">
													<input type="text" onchange="$('input').superScript(this);" id="text"  class="form-control" name="end" >
													</div>
												</div> 
	...
	<div class="col-lg-2">
		<div class="card-body text-center height-3">
			...
			<br/>
							...
							<div class="col-sm-6">
							<div class="col-sm-6">
										<button type="button" class="btn ink-reaction btn-primary" onClick="run_all_normal()">Запуск</button>	
									</div>
                                      <div class="col-sm-6">									
