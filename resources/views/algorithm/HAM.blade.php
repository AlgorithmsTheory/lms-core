				...
				<div class="card style-default-bright">
					<div class="card-head">
						<div class="col-md-6">
							...
							<div class="card card-bordered style-primary" style="top: -40px; height: 700px;">
								...
								<div class="row"  >
									...
									<!--<div class="col-lg-2">
                                        <div class="card-body text-center height-3" style="top: -90px;">
                                            <input type="hidden" id="inputFileNameToSaveAs" value="Алгоритм"></input>
                                            <button type="button" class="btn ink-reaction btn-raised btn-default-light" style="left:35px" onclick="saveTextAsFile()"><i class="md md-file-download"></i></button>
                                            <br/>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="card-body text-center height-3" style="top: -90px;">
                                            ...
                                            <button type="button" onclick="loadFileAsText()" class="btn ink-reaction btn-raised btn-default-light"><i class="md md-file-upload"></i></button>
						...
						<div class="col-md-6">
								...
								<div class="col-lg-12">
									<form class="form" role="form">
										<div class="form-group floating-label">
											<textarea name="task_text" id="task_text" class="form-control" rows="3" placeholder=""></textarea>
							...
							<div class="col-sm-6">
								<div class="col-sm-6">
									<button type="button" class="btn ink-reaction btn-primary" onClick="run_all_normal(false)">Запуск</button>
								</div>
								<div class="col-sm-6">
									<button type="button" class="btn ink-reaction btn-primary" onClick="run_all_normal(true)">Шаг <i class="md md-fast-forward"></i></button>
								</div>
								<br>
