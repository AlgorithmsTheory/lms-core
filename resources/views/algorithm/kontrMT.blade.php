					...
					{{----}}
							{{--<div class="col-md-6">	--}}
								...
								{{----}}
									...
									{{--<div class="card-body">--}}
										{{----}}
										{{--<button type="button" style="top:-15px; left: 30px" class="btn ink-reaction btn-primary" onClick="run_all_turing(0)">Отправить</button>--}}
																		{{----}}
					...
					{{----}}
							{{--<div class="col-md-6">	--}}
								...
								{{----}}
									...
									{{--<div class="card-body">--}}
										{{----}}
										{{--<button type="button" style="top:-15px; left: 30px" class="btn ink-reaction btn-primary" onClick="run_all_turing(1)">Отправить</button>--}}
																		{{----}}
										{{--<form class="form" role="form">--}}
											{{--<div class="form-group floating-label">--}}
...
{{--</div>		--}}
		...
		<section>
			...
			<div class="section-body contain-lg">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="text-primary">Контрольная работа</h1>
					</div><!--end .col -->
					<div class="col-lg-8">
										...
										<div class="card">
											<div class="card-head">
												<ul class="nav nav-tabs pull-right" data-toggle="tabs">
													<li class="active"><a href="#light1">Легкий (2 балла)</a></li>
													<li class=""><a href="#hard1">Сложный (3 балла)</a></li>
												</ul>
												<header></header>
											</div>
											<div class="card-body tab-content">
							...
							<div class="tab-pane active" id="second5">
								...
								<div class="col-md-6">
													...
													<div class="card-body height-6 scroll style-default-bright" style="height: auto;">
														...
														<ul id="b_scents" class="list" data-sortable="true">
															<li id="b_scnt" class="tile">
																...
																<a class="btn btn-flat ink-reaction btn-default" href="#" id="remScnt2">
																	<i class="fa fa-trash"></i>
																</a>
															</li>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="card-body text-center height-3">
												<button type="button" class="btn ink-reaction btn-primary" href="#" id="addScnt2"><i class ="fa fa-plus" ></i></button>
												<br/>
											</div><!--end .card-body -->
										</div>
										<div class="col-md-3">
											<div class="card-body text-center height-3">
												<button type="button" class="btn ink-reaction btn-primary" style="right:30px" href="#" id="reset2">Очистить</button>
												<br/>
											</div><!--end .card-body -->
										</div>
										<div class="col-lg-2">
								...
								<div class="col-md-6">
									...
									<div class="col-lg-12">
										<div class="card">
											<div class="card-head">
												<ul class="nav nav-tabs pull-right" data-toggle="tabs">
													<li class="active"><a href="#light2">Легкий (3 балла)</a></li>
													<li class=""><a href="#hard2">Сложный (4 балла)</a></li>
												</ul>
												<header></header>
											</div>
											<div class="card-body tab-content">
