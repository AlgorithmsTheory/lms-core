			...
			<div class="section-body contain-lg">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="col-lg-2">
							<button type="button" class="btn ink-reaction btn-raised btn-primary"> {!! HTML::linkRoute('ramAddTask', '+ Добавить задачу') !!} </button>
						</div>
					</div>
				</div>
...
<?php
	...
	while($j < $len) {
		...
		print "			
			...
			print "
			<td rowspan=\"5\">";
			echo HTML::linkRoute('ramDeleteTask', 'Удалить', array("task_id" => $row['task_id']));
			echo '</td>';
			print "
			...
			<td>";
			echo HTML::linkRoute('ramEditTask', 'Изменить', array("sequence_id" => $row['sequence_id']));
			print "</td>		
			</tr>";
			$i++;
			if ($i == 5) $i=0;
