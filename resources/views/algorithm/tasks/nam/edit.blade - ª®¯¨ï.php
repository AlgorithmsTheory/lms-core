...
@stop
    ...
    @section('content')
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<article class="margin-bottom-xxl">
									<p class="lead">
										Изменить коэффициенты, по которым ведется оценивание контрольных работ на эмуляторе
									</p>
								</article>
							</div><!--end .col -->
				...
				<div class="col-lg-12">
					<h4>Для рассчета оценки применяется следующая формула: О_j=М_j*К_j*Т_(j )*E_j</h4>
				</div>
...
<div class="card">
			...
			<form class="form-horizontal" method="post" action="{{URL::route('editmtTask', array('id'=> $id))}}">
				<div class="modal-body">
					<div class="input-group">
						<div class="input-group-content">
							<input type="text" id="input_word6" class="form-control" placeholder="Входное слово" name="input_word6"  value="<?php echo $result['efficiency_coef']; ?>" />
						</div>
						<span class="input-group-addon"><i class="md md-arrow-forward"></i></span>
						<div class="input-group-content">
							<input type="hidden" name="_token" value="{{ csrf_token() }}" />
							<input type="text" id="output_word6" class="form-control" placeholder="Верное преобразование" name="output_word6"  / >
						</div>
					</div>
