    ...
    @section('content')
		...
		<section>
			...
			<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-8">
								<h1 class="text-primary">Работа с контрольным материалом по теме "Машина Тьюринга"</h1>
							</div><!--end .col -->
							<div class="col-lg-8">
				...
				<div class="col-lg-offset-1 col-md-6 col-sm-6">
					<form class="form form-validate floating-label" novalidate="novalidate" method="post" action="{{URL::route('addingmt')}}" id="tasksmt">
				<input type="hidden" name="_token" value="{{ csrf_token() }}" />
								...
								<div class="card">
									...
									<div class="card-body">
											...
											<div class="form-group">
												<select id="task_number" name="task_number" class="form-control" required="" aria-required="true">
													<option value="">&nbsp;</option>
											...
											<div class="form-group">
												...
												<label for="variant">Номер варианта</label>
