...
@section ('title')
Эмулятор машины Поста контрольная работа
@stop
...
<p class = 'lead'>
	...
	<div class="col-lg-2">
		<br>
		<button type="button" id="btn_submit" class="btn ink-reaction btn-primary" onClick="submit_task()">Закончить работу</button>
	</div>
	<div class="col-lg-12">
