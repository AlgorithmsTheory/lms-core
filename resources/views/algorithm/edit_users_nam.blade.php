...
<div class="col-md-12 col-sm-6 card style-primary text-center">
    <h1 class="">Переписывание контрольных работ по теме "Нормальные алгоритмы Маркова"</h1>
</div>
<div class="col-lg-offset-1 col-md-10 col-sm-6">
    <div class="card">
        <div class="card-body">
            ...
            <br>
            <br>
            <form action="{{URL::route('edit_users_nam_change')}}" method="POST" id="retest-form" class="form">
            ...
            <table class="table table-condensed" id="retest-table" style="margin-top: 25px;">
                <tr>
                    ...
                    <!-- <td>Число попыток</td> -->
                    <th class="text-center">Последняя оценка</th>
                    <th class="text-center">Возможность прохождения</th>
