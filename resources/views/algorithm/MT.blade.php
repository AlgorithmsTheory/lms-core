					...
					<div class="col-md-6">
							...
							<div class="col-lg-12">
								<form class="form" role="form">
									<div class="form-group floating-label">
										<textarea name="textarea2" id="textarea2" class="form-control" rows="3" placeholder="Для Вашего удобства здесь можно написать условие задачи"></textarea>
						...
						<div class="col-sm-6">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="col-sm-6">
										<button type="button" class="btn ink-reaction btn-primary" onClick="run_all_turing(false)">Запуск</button>
									</div>
									<div class="col-sm-6">
										<button type="button" class="btn ink-reaction btn-primary" onClick="run_all_turing(true)">Шаг <i class="md md-fast-forward"></i></button>
									</div>
								</div>
