...
<div class="card-body">
    						...
    						<h3>{!! link_to_route('edit_date_mt', 'Редактирование дат и групп проведения контрольных мероприятий по теме "Эмулятор машины Тьюринга"') !!}</h3> <br>
    						<h3>{!! link_to_route('edit_date', 'Редактирование дат и групп для проведения контрольных мероприятий по теме "Нормальные алгоритмы Маркова"') !!}</h3> <br>
    						<h3>{!! link_to_route('edit_users_mt', 'Переписывание контрольной работы по теме "Машина Тьюринга"') !!}</h3> <br>
    						<h3>{!! link_to_route('edit_users_nam', 'Переписывание контрольной работы по теме "Нормальные алгоритмы Маркова"') !!}</h3> <br>
