...
@section('content')
        ...
        <div id="main_container">
            <div class="card col-lg-12 col-md-12 col-sm-12">
                <div class="card-body">
                    ...
                    <h1 class="text-center">Эмулятор ПРФ двух переменных</h1>
                    <hr>
                    <br>
                ...
                <div class="nano has-scrollbar" style="height: 318px;">
                    <div class="nano-content" tabindex="0" style="right: -17px;">
                        <div class="offcanvas-body">
                            <p>Данный эмулятор примитивно-рекурсивных функций двух параметров позволяет сравнивать ПРФ с функцией в аналитическом виде.</p>
                            ...
                            <ul class="list-divided">
                                ...
                                <li> <b>Аналитический вид</b> имеет стандартный вид относительно переменных <b>x, y</b>, псевдоразность обозначается обычным минусом (<b>-</b>), факториал обозначается: <b>fac(x)</b>. <b>Пример: 10+2*x</b></li>
    ...
    {!! HTML::script('js/recursion/recursion_two.js') !!}
