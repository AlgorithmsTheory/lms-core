...
<div class="col-md-12 col-sm-6 card style-danger">
    ...
    <h2 class="text-default-bright">В новой попытке вы сможете набрать не больше {{ $max_test_points }} баллов из {{ $total }}.</h2>
    <h2 class="text-default-bright"> Обратитесь к вашему преподавателю для переписывания.</h2>
</div>
<div class="row">
