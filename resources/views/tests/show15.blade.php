...
<input type="hidden" id="debug_counter" name="debug_counter" value="0">
<input type="hidden" id="sequences_true" name="sequences_true" value="0">
<input type="hidden" id="sequences_all" name="sequences_all" value="0">
@include('algorithm.RAMtest')
@if (!$is_adaptive)
