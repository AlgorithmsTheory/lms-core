                    ...
                    <div class="card-body">
                        ...
                        <div id="type_question_add">
                            ...
                            <div class="col-md-2 col-sm-2" id="variants">
                                <div class="form-group">
                                    <textarea name="title" class="form-control textarea3" rows="3" placeholder="" required>{{ $data['question']['title'] }}</textarea>
                                    <label for="textarea3">Определение</label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4" id="answers">
                                <div class="form-group">
                                    <textarea name="answer" class="form-control textarea3" rows="3" placeholder="" required>{{ $data['question']['answer'] }}</textarea>
                                    <label for="textarea3">Расшифровка</label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-2" id="eng-variants">
                                <div class="form-group">
                                    <textarea name="eng-title" class="form-control textarea3" rows="3" placeholder="">{{ $data['question']['title_eng'] }}</textarea>
                                    <label for="textarea3">Definition</label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4" id="eng-answers">
                                <div class="form-group">
                                    <textarea name="eng-answer" class="form-control textarea3" rows="3" placeholder="">{{ $data['question']['answer_eng'] }}</textarea>
                                    <label for="textarea3">Transcript</label>
                                </div>
                            </div>
