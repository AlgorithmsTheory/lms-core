                    ...
                    <div class="card-body">
                        ...
                        <div id="type_question_add">
                            ...
                            <div id="variants" class="col-md-5 col-sm-5">
                                <div class="form-group">
                                    <textarea name="title" class="form-control textarea3" rows="1" placeholder="" required>{{ $data['question']['title'] }}</textarea>
                                    <label for="textarea3">Утверждение</label></div></div>
                            <div id="eng-variants" class="col-md-5 col-sm-5">
                                <div class="form-group">
                                    <textarea name="eng-title" class="form-control textarea3" rows="1" placeholder="">{{ $data['question']['title_eng'] }}</textarea>
                                    <label for="textarea3">Statement</label>
                                </div>
                            </div>
