                        ...
                        <div id="type_question_add">
                            ...
                            <div id="variants" class="col-md-6 col-sm-6">
                                <div class="form-group col-md-6 col-sm-6">
                                    <textarea  name="variants[]"  class="form-control textarea3" rows="1" placeholder="" required>{{$data['variants'][0]}}</textarea>
                                    <label for="textarea3">Точка 1</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <textarea  name="answers[]"  class="form-control textarea3" rows="1" placeholder="" required>{{$data['answers'][0]}}</textarea>
                                    <label for="textarea3">Значение 1</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <textarea  name="variants[]"  class="form-control textarea3" rows="1" placeholder="" required>{{$data['variants'][1]}}</textarea>
                                    <label for="textarea3">Точка 2</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <textarea  name="answers[]"  class="form-control textarea3" rows="1" placeholder="" required>{{$data['answers'][1]}}</textarea>
                                    <label for="textarea3">Значение 2</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <textarea  name="variants[]"  class="form-control textarea3" rows="1" placeholder="" required>{{$data['variants'][2]}}</textarea>
                                    <label for="textarea3">Точка 3</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <textarea  name="answers[]"  class="form-control textarea3" rows="1" placeholder="" required>{{$data['answers'][2]}}</textarea>
