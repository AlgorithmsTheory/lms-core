...
@section('head')
    <title>Добавление новой теоремы</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
                ...
                <section>
                    <div class="section-header">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Добавление новой теоремы</li>
                        </ol>
    ...
    <div class="card card-tiles style-default-light">
        ...
        <div class ="container-fluid">
            ...
            <div class="col-lg-11 col-md-11">
                ...
                {!! Form::open(array('url' => 'library/theorems/store')) !!}
                <div class="form-group">
                    <h4> {!! Form::label('theorem_name', 'Название теоремы:') !!}</h4>
                    {!! Form::text('theorem_name',null,['class' => 'form-control','placeholder' => 'Введите название теоремы']) !!}
                </div>
                <div class="form-group">
                    <h4> {!! Form::label('theorem_content', 'Формулировка теоремы:') !!}</h4>
                    {!! Form::textarea('theorem_content',null,['class' => 'form-control','placeholder' => 'Введите формулировку теоремы']) !!}
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="form-control btn ink-reaction btn-primary">Добавить теорему</button>
                </div>
                {!! Form::close() !!}
                @if ($errors->any())
