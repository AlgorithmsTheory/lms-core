...
Route::get('tests/edit-structure/{id_test}', ['as' => 'test_edit_structure', 'uses' => 'TestController@editStructure']);
Route::post('tests/edit-structure', ['as' => 'test_change_structure', 'uses' => 'TestController@changeStructure']);
