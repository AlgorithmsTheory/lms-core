...
/**
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question whereId_question($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereTitle($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereVariants($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereAnswer($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereSection_code($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereTheme_code($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereType_code($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  wherePoints($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Testing\Testing\Question  whereControl($value)
 *
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  get()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  where()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  whereRaw()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  orWhere()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  select()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  first()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  insert($array)
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  table($array)
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  max($array)
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  count()
 * @method static \Illuminate\Database\Eloquent|\App\Testing\Testing\Question  toSql()
 *
 */
