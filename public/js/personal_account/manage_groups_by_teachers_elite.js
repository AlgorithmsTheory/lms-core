...
(function() {
  ...
  async function addClick() {
    ...
    groupsEl.empty();
    try {
      resp = await post('/manage_groups_other_groups', {
        teacherId: teacherId,
      });
    } catch (er) {
      alert(er.message);
  ...
  async function saveAddClick() {
    ...
    try {
      newGroups = await post('/manage_groups_add_groups_to_teacher', request)
    } catch (er) {
      alert(er.message);
  ...
  async function removeClick() {
    ...
    let newGroups;
    try {
      newGroups = await post('/manage_groups_remove_group_from_teacher', request)
    } catch (er) {
      alert(er.message);
      return;
    }
