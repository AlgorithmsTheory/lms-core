        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == true) {
                    ...
                    alert('Данный набор струтктур не может обеспечить, чтобы каждая из них была наполнена вопросами. Попробуйте уменьшить число вопросов и повторите попытку. Для адаптивного теста суммарное число вопросов в структурах не должно превышать максимальное число вопросов теста, заполненное на предыдущем шаге.');
                    submit = false;
                }
            },
            error: function (error) {
