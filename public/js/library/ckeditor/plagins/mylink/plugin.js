	...
	CKEDITOR.plugins.add( 'mylink', {
		...
		onLoad: function() {
			...
			var template = '.%2 a.cke_anchor,' +
                ...
                ',.cke_editable.%2 a[data_cke_theme_anchor]' +
				'{' +
					baseStyle +
					'padding-%1:18px;' +
		...
		init: function( editor ) {
			var allowed = 'a[!href, data_cke_theme_anchor]',
				required = 'a[href, data_cke_theme_anchor]';
			...
			editor.addCommand( 'anchor', new CKEDITOR.dialogCommand( 'anchor', {
				allowedContent: 'a[!name,id, data_cke_theme_anchor]',
				requiredContent: 'a[name, data_cke_theme_anchor]'
			} ) );
